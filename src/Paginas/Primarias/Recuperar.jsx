...
function Recuperar() {
  ...
  const handleSubmit = (e) => {
    ...
    setSucesso("Enviamos um código de confirmação para o seu email.");
        ...
        >
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              type="submit"
              className="w-full mt-2 p-3 bg-blue-600 text-white rounded-xl text-lg font-semibold hover:bg-blue-700 transition"
            >
              Enviar Código
            </motion.button>
          </form>
